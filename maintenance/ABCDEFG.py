...
if __name__ == "__main__":
    source_folder = r"C:\Users\PlicEduard\AI4_SOC\classes\every2"  # Replace with the path to your source folder
    destination_folder = r"C:\Users\PlicEduard\AI4_SOC\classes\A-B-C-D-E-F-H"  # Replace with the path to your destination folder
