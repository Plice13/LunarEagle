...
def get_middle():
    # Open the FITS file
    fits_file_path = 'wcs_automatic.fits'
...
def write_to_csv():
    with open(csv_file, mode='a', newline='') as file:
        ...
        writer.writerow([image_path,(CRVAL1,CRVAL2),scale_degrees, scale_degrees*3600])
...
if __name__ == '__main__':
    ...
    #with open(csv_file, mode='w', newline='') as file:
        #csv.writer(file).writerow(['IMG_name','center','field[deg]','field[arc]'])
    ...
    image_path = max_file_name
    wcs_output_path = 'wcs_automatic.fits'
    ...
    parser.add_option('--crpix-center', dest='crpix_center', action='store_true', default=True, help='Set reference point to center of image?')
